...
# Plan Sur (V-30): Protección de València Capital al norte del nuevo cauce
is_valencia_capital_infra = y_pts > (4371400.0 - 0.45 * (x_pts - 720000.0))
if not sim_turia:
    all_infra_h[is_valencia_capital_infra] = 0.0
...
if not active_df.empty:
    ...
    # Plan Sur (V-30): Protección de València Capital para parcelas
    mask_val_norte = y_c > (4371400.0 - 0.45 * (x_c - 720000.0))
    if not sim_turia:
